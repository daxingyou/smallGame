                ...
                for(let i = 0; i < 3; i++)
                {
                        ...
                        case 100112:
                            ...
                            for(let k = 0; k < lie; k++)
                            {
                                for(let j = 0; j < 12; j++)
                                {
                                    ...
                                    let vo:RoleVo = {level:1,atk:100,hp:100,type:ownSolderis[i].soldierType,id:ownSolderis[i].soldierID}
                    ...
                    if(formation == 6)
                    {
                        ...
                        if(!bool)
                        {
                            ...
                            let vo:RoleVo = {level:1,atk:200,hp:500,type:CardType.general,id:ownSolderis[i].generalId}
