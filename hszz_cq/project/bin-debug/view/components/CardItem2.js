...
var CardItem2 = (function (_super) {
    ...
    CardItem2.prototype.closeTouch = function () {
    ...
    CardItem2.prototype.setData = function (data) {
        ...
        this.nameLab.textColor = data.qualityColor;
        this.levelLab.text = data.ownNum.toString();
        this.img.source = "box_card_" + data.cardId + "_png";
        this._cardVo = data;
    };
