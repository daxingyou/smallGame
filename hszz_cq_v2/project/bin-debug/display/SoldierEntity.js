...
var SoldierEntity = (function (_super) {
    ...
    SoldierEntity.prototype.onMpChange = function (value) {
        if (!isNaN(value)) {
            if (this._mp < this._tmp) {
                if (!this.timeInterVal) {
                    var self_1 = this;
                    this.timeInterVal = setInterval(function () {
                        self_1.changeRoleMp(-10);
                    }, 1000);
                }
            }
            else {
            ...
            if (this.curState != ActionState.ATTACK) {
                ...
                var timeout_1 = setTimeout(function () {
                    ...
                    if (self_2 && self_2._atkTar) {
                        ...
                        var value = null;
                        if (critIndex >= 60) {
                            value = ((atk * self_2._crit) >> 0);
                        }
                        self_2._atkTar.reduceHp(atk + self_2.buffAttack, value);
