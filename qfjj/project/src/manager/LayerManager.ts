class LayerManager extends BaseClass{
	...
	public static readonly OPEN_SHOW:eui.UILayer = new eui.UILayer();
	...
	public iniaizlize(p:egret.DisplayObjectContainer):void{
		...
		p.addChild(LayerManager.OPEN_SHOW);
		LayerManager.OPEN_SHOW.name = "show"
		LayerManager.OPEN_SHOW.touchThrough = true;
	}
}