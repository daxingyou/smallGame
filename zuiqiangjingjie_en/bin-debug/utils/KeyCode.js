...
var KeyCode = (function () {
    ...
    KeyCode.KC_BACKSPACE = 8; //backspace Backspace key
    KeyCode.KC_TAB = 9; //tab Newline key
    KeyCode.KC_ENTER = 13; //main ENTER Enter key（Main keyboard area）
    KeyCode.KC_SHIFT = 16; //shift 
    KeyCode.KC_CONTROL = 17; //ctrl
    KeyCode.KC_ESCAPE = 27; //esc
    KeyCode.KC_SPACE = 32; //space Space key
