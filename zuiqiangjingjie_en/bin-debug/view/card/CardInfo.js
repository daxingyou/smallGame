    ...
    CardInfo.prototype.init = function () {
        ...
        switch (this._type) {
            case CardType.special_skill:
                this.hp_label.text = "nothing";
                this.atk_label.text = "nothing";
                this.talent_label.text = "nothing";
        ...
        switch (e.target) {
            ...
            case this.upgrade_img:
                ...
                if (cfg.cost <= GameApp.exp) {
                    ...
                    UserTips.inst().showTips("Upgrade success！");
                    // this.removeThis();
                    this.UIReset();
                    ...
                    UserTips.inst().showTips("Lack of experience！");
                    // ViewManager.inst().open(RechargeTipPop);
                }
                // } else {
                //     UserTips.inst().showTips( "Insufficient card！" );
                // }
                break;
        }
    };
