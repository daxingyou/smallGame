...
var StartGameView = (function (_super) {
    ...
    function StartGameView() {
        ...
        _this.talk_str = [
            "Now the world is in chaos，Three countries jostle each other，Does the LORD have the heart to fight for the world？",
            "discretion in speech！Easier said than done，Pity me, young general！",
            "If the Lord really has such ambition，Just clear it up，The king to be sent to a suitable place as a foundation，Quietly recruiting，When the time is right, we can succeed。",
            "You can have a good choice？",
            "Look at the Lord please.。。"
        ];
        _this.talk_num = 0;
        _this.talk_state = 0;
        _this.ox = 0;
        ...
        switch (e.target) {
            ...
            case this.start_btn:
                ...
                if (this.select_id != -1) {
                    ...
                    UserTips.inst().showTips("Please select a city first！");
                }
                break;
        }
    };
