...
class GameApp extends BaseClass {
	...
	/**Whether the main city opens tax */
	...
	public static readonly tolevel:number = 13;

	/**Information of current battle city level */
	...
	public load() {
		...
		if(!roleInfo){
			...
			let obj:RoleInfoVo = {name:"Name",citys:cityArr};
...
interface SoldierRect{
	genrealRes:string;
	/**Type of arms  123 arch step ride */
	soldierType:number;
	/**ArmsID */
	soldierID:number;
	/**Generalid */
