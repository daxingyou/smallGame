...
var Hp = (function (_super) {
    __extends(Hp, _super);
    function Hp(_hp, _level) {
        var _this = _super.call(this) || this;
        _this.hp_num = _this.hp_max = _hp;
        _this.skinName = "HpSkin";
        _this.titleIcon.source = "title_icon_" + _level + "_png";
        _this.init();
        return _this;
    }
    ...
    Hp.prototype.setHp = function (_num) {
        if (this.hp_num >= 0) {
            this.hp_num -= _num;
            this.hp_mask.x = -(this.tiao.width - this.hp_num * (this.tiao.width / this.hp_max));
        }
    };
    Hp.prototype.addHp = function (_num) {
        this.hp_num += _num;
