class CollectView extends BaseEuiView{
	...
	// private _transRect:egret.Rectangle = new egret.Rectangle(2208,113,220,202);
	...
	public open(...param):void{
		...
		MapView.ins<MapView>().resetMapviewPort();
	...
	private onCloseInfo():void{
		...
		// 	this.infoGroup.parent.removeChild(this.infoGroup);
			...
			egret.Tween.get(this.cityBtn).to({top:10},600,egret.Ease.circOut).call(()=>{
