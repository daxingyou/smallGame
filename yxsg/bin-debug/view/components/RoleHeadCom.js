...
var RoleHeadCom = (function (_super) {
    ...
    RoleHeadCom.prototype.childrenCreated = function () {
        ...
        if (campstr) {
            var campCfg = CampCfg.campCfg[parseInt(campstr)];
        ...
        eui.Binding.bindHandler(GameApp.ins(), ["rolePower"], this.onPowerChange, this);
        // this.addEventListener(egret.TouchEvent.TOUCH_TAP,this.ontouchTap,this);
    };
    RoleHeadCom.prototype.onPowerChange = function (value) {
